var popup = {
      ...
      for (var i = 0; i < lang.length; i++) {
        ...
        $e.on('click', function () {
          ...
          chrome.tabs.create({url:
            'https://docs.google.com/forms/d/12jQoKB_fs8f22jbe5TaF_XYZtxoR0Qf9Q_vyzsy_VUE/edit?usp=forms_home&ths=true' +
            t.getAttribute('lang')
          });
        });
  ...
  // sends a one-time JSON-serializable message from a content script to extension
