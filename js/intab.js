...
var page = {
  ...
  // restore page after loading pages
  restore: function () {
...
//page.onRequest is listener for message from extension
...
if (location.href.match('https://www.userstory.in')) {
